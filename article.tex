...
We decided, that since the dataset was so small, that we would manually infer the horsepower based on looking at other cars, with similar values, and deduct the missing horsepower out of common sense and educated guesses. 
